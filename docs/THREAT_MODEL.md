...
| Ability to reach emergency services | None needed (safety failure); also misconfiguration, 2G off, VoLTE failure | Emergency number tables, emergency domain selection, radio technology availability | Stock-equivalent emergency configuration; 2G kept allowed by default | No evidence yet that emergency calls or emergency location delivery work; no claim until an authorised test | Emergency-call validation (FP6-027) | Assumption. |

...
- 2026-09-26: from the GrapheneOS branding inventory, added network location,
  ...
  DiamaneOS EU relay to Apple or Apple directly, both opt-in and off by
  default, and no DiamaneOS geocoder: geocoding stays off unless the user opts
